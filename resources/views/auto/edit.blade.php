...
@section('content')
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header">Redaguoti autoservisą</div>

                    <div class="card-body">
                        <form method="POST" action="{{route('ac_update', $aService)}}">
                            @csrf
                            @method('put')
                            <div class="row mb-3">
                                <label for="name" class="col-md-4 col-form-label text-md-end">Pavadinimas</label>
                                <div class="col-md-6">
                                    <input id="name" type="text" class="form-control" name="name" value="{{$aService->name}}">
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <input id="phone" type="text" class="form-control" name="phone" value="{{$aService->phone}}">
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <input id="address" type="text" class="form-control" name="address" value="{{$aService->address}}">
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <select id="paslauga_id" name="paslauga_id" class="form-select form-select-sm">
                                    @foreach($paslaugos as $paslauga)
                                        <option value="{{$paslauga->id}}" @if ($paslauga->id == $aService->paslauga_id) selected @endif>{{$paslauga->name}}</option>
                                    @endforeach
                                </select>
                            </div>
